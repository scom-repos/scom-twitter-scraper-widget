...
import { AccountData, ScrapeResult } from './result';
...
export class ScrapflyClient {
    HOST: string = 'https://api.scrapfly.io';
    key;
    ua;
     ...
     */
    errResult(response: AxiosResponse, result: ScrapeResult) {
        ...
        const httpStatusErrMap: {[key: number]: any} = {
